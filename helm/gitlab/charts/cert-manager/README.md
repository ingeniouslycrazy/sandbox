...
$ helm install my-release --namespace cert-manager --version v1.12.16 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.12.16/cert-manager.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.12.16` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.12.16` |
...
| `acmesolver.image.tag` | acmesolver image tag | `v1.12.16` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.12.16` |
